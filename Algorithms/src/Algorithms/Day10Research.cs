...
,"10456732"
        ...
        public static void Run()
        {
            ...
            var temp = map.GetTrailHeads().SelectMany(trailhead => trailhead.WalkFrom(map)).ToList();
        ...
        private static IEnumerable<((int row, int column) point, int count)> WalkFrom(this (int row, int column) trailhead, char[][] map)
        {
        ...
        private static IEnumerable<(int row, int column)> GetUphillNeighbors(this char[][] map,
        ...
        private static bool IsUphill(this char[][] map, (int row, int column) a, (int row, int column) b) =>
            map.IsOnMap(a) &&
            map.IsOnMap(b) &&
            map.At(b) == map.At(a) + 1; //<== nice.
